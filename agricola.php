<?php include('header.php'); ?>
    ...
    <div id="wrapper-financiacion">
        ...
        <div class="title-services">
            <figure>
                <div class="flexslider">
                    <ul class="slides">
                        <li>
                            <img src="images/secciones/14.jpg" />
                        </li>
                        <li>
                            <img src="images/secciones/14-1.jpg"/>
                        </li>
        ...
        <div class="experiencias">
            <ul>
                <li><a href="">Planeaciones de palma y aceite</a></li>
                <li><a href="">Biocombustibles</a></li>

            </ul>
            <ul>
                <li><a href="">Puertos y aeropuertos</a></li>
                <li><a href="">Planteaciones forestales</a></li>
            </ul>
            <ul>
                <li><a href="">Frutas Exóticas</a></li>
            </ul>
        </div>
